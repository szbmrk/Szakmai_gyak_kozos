        ...
        <div className="flex">
            <div className="container">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <button className="teacher_button" type="submit">Login</button>
                </form>
            </div>
            {role === "student" ? <button className="teacher_button" onClick={changeLoginPage} type="button">Switch to teacher login page</button> :
                <button className="teacher_button" onClick={changeLoginPage} type="button">Switch to student login page</button>}
        </div>
